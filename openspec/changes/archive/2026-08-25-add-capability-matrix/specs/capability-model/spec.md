...
- **WHEN** the support status of every acquisition mode is inspected while its implementation plan item is still open
- **THEN** no mode reports `Supported`
